...
// Todo一覧の取得
app.get("/todos", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// 特定のTodoの取得
app.get("/todos/:id", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// Todoの作成
app.post("/todos", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let body;
        try {
...
// Todoの更新
app.put("/todos/:id", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = parseInt(c.req.param("id"));
        if (isNaN(id)) {
            throw new error_1.ValidationError("Invalid ID format");
...
// Todoの削除
app.delete("/todos/:id", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = parseInt(c.req.param("id"));
        if (isNaN(id)) {
            throw new error_1.ValidationError("Invalid ID format");
